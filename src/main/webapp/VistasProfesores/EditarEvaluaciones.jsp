...
<div class="container">
    ...
    <%int idEvaluacion = Integer.parseInt((String) request.getAttribute("idEvaluacion"));%>
    <%Evaluaciones eva = new DaoEvaluaciones().getEvaluacionesXIdEvaluacion(idEvaluacion);%>
    <div class="forms">
            ...
            <div class="signup-form">
                ...
                <form method="POST" action="GestionCursosServlet?action=edit" class="col-md-6 col-lg-6">
                    ...
                    <div class="input-boxes">
                        <div class="mb-3">
                            <input type="hidden" class="form-control" name="idEvaluacion" value="<%=idEvaluacion%>">
                        </div>
                        <div class="input-box">
                            <i class="fas fa-user"></i>
                            <input type="text" name="nombre" value="<%=eva.getNombreEstudiantes()%>" required>
                        </div>
                        <div class="input-box">
                            <i class="fas fa-user"></i>
                            <input type="text" name="codigo" value="<%=eva.getCodigoEstudiantes()%>"  required>
                        </div>
                        <div class="input-box">
                            <i class="fas fa-envelope"></i>
                            <input type="email" name="correo" value="<%=eva.getCorreoEstudiantes()%>"  required>
                        </div>
                        <div class="input-box">
                            <i class="fas fa-user"></i>
