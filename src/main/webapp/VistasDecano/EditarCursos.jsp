...
<div class="container">
    ...
    <%Curso curso = new DaoCurso().getCursoxIdCurso(Integer.parseInt(idCurso));%>
    <div class="forms">
        <div class="form-content">
            <div class="signup-form">
                <div class="title">Edita el nombre del curso</div>
                <form method="POST" action="GestionCursosServlet?action=edit" class="col-md-6 col-lg-6">

                    <div class="input-boxes">
                        <div class="mb-3">
                            <input type="hidden" class="form-control" name="idCurso" value="<%=idCurso%>">
                        </div>
                        <div class="input-box">
                            <i class="fas fa-user"></i>
                            <input type="text" name="nombre" placeholder="Ingresa un nombre" value="<%=curso.getNombre()%>"required>
                        </div>
